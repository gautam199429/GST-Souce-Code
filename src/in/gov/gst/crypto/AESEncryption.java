    ...
    */
    ...
    private static void produceSampleData(){
    	try {
			...
			String otp = "943269";
			String encryptedOtp = encryptEK(otp.getBytes(),decodeBase64StringTOByte("QAx3X/0cuQqCSgJXqzBJcU464wsEuYXU1txBw7H81/g="));
...
//App key in encoded :QAx3X/0cuQqCSgJXqzBJcU464wsEuYXU1txBw7H81/g=
//Encrypted App Key :
//Encrypted OTP :oAp8C4YXBeFFWho+jRvOjw==
